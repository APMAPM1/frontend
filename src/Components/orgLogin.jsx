...
function Login() {
  ...
  return (
    <div className="h-screen flex items-center justify-center bg-green-200 font-sans">
      <div className="mx-auto bg-white p-5 w-[600px] rounded shadow-md text-center">
      ...
      <form className="flex flex-col" onSubmit={handleSubmit}>
        ...
        <input
          ...
          required
        />
        <button type="submit" className="p-2 m-2 bg-[#19514F] text-white rounded cursor-pointer hover:bg-[#379683] hover:text-[#ffffff]">
          Login
        </button>
      </form>
    </div>
